...
export default function LearningByDoing() {
  ...
  return (
    <section
      ref={ref}
      className="flex flex-col items-center px-4 pt-16 pb-0"
    ...
    >
      ...
      >
        A 12-week, hands-on experience where learning happens inside real
        investor meetings, live decisions, and shared outcomes.
      </motion.p>
    </section>
  );
}
