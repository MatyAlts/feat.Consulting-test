...
export default function FinalCTADesktop() {
  ...
  return (
    <section className="relative w-full py-40 overflow-hidden bg-white flex flex-col items-center justify-center">
      ...
      >
        <h2
          className="font-avenir-medium text-white leading-[1.1] tracking-tight"
          style={{ fontSize: "64.5px", marginBottom: "4px" }}
        >
          Ready for the <br /> Next Step?
        </h2>

        <p
          className="font-avenir-regular text-[#94969C] max-w-xl mx-auto leading-relaxed"
          style={{ fontSize: "22px", marginBottom: "16px" }}
        >
          If you're serious about learning through real{" "}
          <br className="hidden md:block" /> decisions, let's talk.
        </p>
