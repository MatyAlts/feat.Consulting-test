    ...
    >
      ...
      <div className="flex-1 relative flex items-center">
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(250,212,110,0.35) 0%, transparent 70%)",
            filter: "blur(18px)",
          }}
...
export default function StickyCountdownFooterDesktop({
  activated,
  ...
  const isVisible =
    activated && !suppressed && !externallySuppressed && !hasReachedEnd;
