...
const TARGET_DATE =
  import.meta.env.VITE_COUNTDOWN_DATE || "2025-09-01T00:00:00";
  ...
  return (
    <div className="flex flex-col items-center">
      <span
        ...
        style={{ fontSize: "18.72px", lineHeight: 1 }}
      >
        {String(value).padStart(2, "0")}
      </span>
      <span
        className="font-avenir-light mt-0.5"
...
function Colon() {
  return (
    <span
      className="font-avenir-heavy text-white self-start mt-0.5"
      style={{ fontSize: "18.72px", opacity: 0.7 }}
    >
      :
    </span>
  );
  ...
  return (
    <div className="w-full max-w-[428px] mx-auto flex flex-col items-center pointer-events-auto">
      ...
      >
        ...
        <p
          className="font-avenir-regular text-center mb-2 text-white"
          style={{ fontSize: "16px" }}
        >
        ...
        <div className="relative flex justify-center w-full px-3">
          ...
          <motion.div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(165,243,252,0.4) 0%, transparent 70%)",
              filter: "blur(15px)",
              zIndex: 0,
              width: "90%",
              height: "100%",
        ...
        <p
          className="font-avenir-light text-center mt-2.5"
